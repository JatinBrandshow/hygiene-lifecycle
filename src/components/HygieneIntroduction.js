            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-stretch">
                    ...
                    <div className="lg:w-1/2">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl min-h-[300px] h-full"> {/* Further reduced min-height */}
                            <Image
                                ...
                                priority
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-[var(--tertiary)]/90 via-[var(--tertiary)]/30 to-transparent flex items-end p-6"> {/* Reduced padding */}
                    ...
                    <div className="lg:w-1/2 space-y-6 animate-fadeInUp flex flex-col justify-center">
                        <div className="animate-slideInRight">
                            <h2 className="text-3xl md:text-4xl font-bold text-[var(--tertiary)] mb-4">
                                <span className="text-[var(--primary)]">Welcome to</span> Hygiene Lifesciences
                            </h2>
                        ...
                        <div className="space-y-4 animate-fadeIn delay-100">
                            <p className="text-gray-700 leading-relaxed animate-slideInUp">
                                Founded in 2006, Hygiene Lifesciences has State-of-the-Art World Class WHO GMP-GLP Certified Manufacturing facilities.
                            </p>

                            <p className="text-gray-700 leading-relaxed animate-slideInUp delay-200">
                                We specialize in advanced sterile manufacturing processes for pharmaceutical products with focus on quality and compliance.
                            </p>
                            ...
                            <p className="text-gray-700 leading-relaxed font-medium animate-slideInUp delay-400">
                                Hygiene Lifesciences is one of the fastest growing quality solutions providers in healthcare - Focused on Delivering Global Standard Systems at Competitive Prices.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 animate-fadeIn delay-500">
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--primary)] text-lg animate-bounce">
                                    🧼
                                </div>
                                <div>
                            ...
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--primary)] text-lg animate-pulse">
                                    🌡️
                                </div>
                                <div>
                            ...
                            <div className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--primary)] text-lg animate-spin">
                                    📋
                                </div>
                                <div>
...
export default HygieneIntroduction;