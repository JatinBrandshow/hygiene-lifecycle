...
const VisionMission = () => {
  return (
    <div className="font-sans bg-gray-50">
      {/* Hero Banner with refined gradient */}
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
            Redefining Healthcare Standards <span className="text-blue-600">Globally</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              icon: <FaRegHandshake className="text-4xl text-blue-600" />,
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Strategic Roadmap for <span className="text-blue-600">2030</span>
            </h2>
            <div className="w-20 h-1 bg-gradient-to-r from-blue-500 to-green-500 mx-auto mb-6"></div>
      ...
      <section className="py-20 max-w-5xl mx-auto px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {[
            ...
            {
              icon: <FaMicroscope className="text-amber-600 text-2xl" />,
            ...
            <div 
              key={index} 
              className={`bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border-t-4 border-${item.color}-500 hover:-translate-y-1`}
            >
      ...
      <section className="py-20 bg-gradient-to-r from-blue-800 to-indigo-900 text-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Advancing <span className="text-cyan-300">Global Health</span>
          </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8 mt-12">
            {[
              ...
              >
                ...
                <p className="text-blue-100/90">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
