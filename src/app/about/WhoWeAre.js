    ...
    <div className="bg-white text-gray-800 overflow-hidden">
      ...
      <section className="relative w-full h-[80vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 text-center">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-400 to-purple-400 mb-8" />
      ...
      <section className="relative z-30 -mt-20 md:-mt-32 px-4">
        ...
        >
          <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
            <svg
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-10">
            <span className="relative inline-block">
              Empowering Global Health
              <span className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transform translate-y-2" />
            </span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-2 rounded-full mr-4 mt-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-lg md:text-xl leading-relaxed">
                  <strong className="text-blue-800">Shamshree Lifesciences</strong> is a{" "}
                  <strong className="text-purple-800">WHO GMP-GLP</strong> certified pharmaceutical
                  company with a world-class manufacturing plant in{" "}
                  <strong className="text-blue-800">Baddi (H.P.), India</strong>.
                </p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="text-lg md:text-xl leading-relaxed">
                  We specialize in <strong className="text-blue-800">Dry Powder Injectables</strong> – 
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border-l-4 border-blue-600">
              <h3 className="text-2xl font-semibold text-blue-800 mb-4">Global Reach</h3>
              <p className="text-lg leading-relaxed mb-6">
                Exporting across <strong className="text-blue-700">Africa</strong>,{" "}
                <strong className="text-purple-700">Latin America</strong>,{" "}
                <strong className="text-blue-700">Southeast Asia</strong>, and{" "}
                <strong className="text-purple-700">CIS</strong> nations.
              </p>
              <div className="flex flex-wrap gap-2">
                {['Africa', 'Latin America', 'Southeast Asia', 'CIS', 'Middle East'].map((region) => (
                  <span key={region} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-3 py-1 rounded-full text-sm">
                    {region}
                  </span>
                ))}
              </div>
      ...
      <section className="py-20 px-6 md:px-10 bg-gradient-to-b from-white to-gray-50 relative">
            ...
            {[
              {
                ...
                desc: "Certified by WHO GMP-GLP and trusted by international agencies.",
                icon: (
              ...
              {
                title: "25+ Countries",
                desc: "Exports across Africa, Asia, Latin America, and CIS regions.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div
                key={index}
                className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl border border-gray-100 hover:border-blue-200 transition-all duration-300 group relative overflow-hidden"
              >
                <span className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-blue-600 to-purple-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500" />
                <div className="bg-gradient-to-r from-blue-100 to-purple-100 w-16 h-16 rounded-full flex items-center justify-center mb-6 text-blue-600 group-hover:from-blue-600 group-hover:to-purple-600 group-hover:text-white transition-colors">
                  {item.icon}
                </div>
                <h4 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-blue-700 transition-colors">
                  {item.title}
                </h4>
      ...
      <section className="py-20 px-6 md:px-10 bg-gray-50 relative overflow-hidden">
        <div className="absolute -right-20 -top-20 w-64 h-64 bg-blue-200 rounded-full opacity-20" />
        <div className="absolute -left-20 -bottom-20 w-64 h-64 bg-purple-200 rounded-full opacity-20" />
            ...
            <div className="grid md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 bg-gray-50">
              {[
                ...
                <div key={index} className="p-6 text-center group relative overflow-hidden">
                  <span className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-blue-600 to-purple-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500" />
                  <h4 className="text-xl font-bold text-blue-700 mb-2 group-hover:text-purple-700 transition-colors">
                    {item.region}
                  </h4>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-100">
              <div className="flex items-center mb-6">
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 rounded-lg mr-6">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h4 className="text-2xl font-bold text-blue-800">Manufacturing Excellence</h4>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8 border border-purple-100">
              <div className="flex items-center mb-6">
                ...
                <h4 className="text-2xl font-bold text-purple-800">Research & Development</h4>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-600 mt-1 mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
