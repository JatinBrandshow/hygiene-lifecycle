...
const Manufacturing = () => {
    const [isOpen, setIsOpen] = useState(false); // For video popup toggle
            ...
            <div className="relative h-[600px] bg-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
                    <div className="max-w-3xl">
                        <div className="mb-6">
                            <span className="inline-block px-4 py-2 bg-[#EB006F]/10 text-[#EB006F] rounded-full text-sm font-medium">Hygine Lifesciences Pvt Ltd Manufacturing</span>
                        </div>
                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                            Precision <span className="text-[#173C96]">Manufacturing</span> Excellence
                        </h1>
                        <p className="text-xl text-gray-600 mb-8 max-w-2xl">Delivering world-class pharmaceutical products through cutting-edge technology and uncompromising quality standards.</p>
                        <div className="flex gap-4">
                            <button className="px-6 py-3 bg-[#173C96] text-white rounded-lg font-medium hover:bg-[#031B4E] transition-all">Explore Capabilities</button>
                ...
                <div className="absolute right-0 top-0 bottom-0 w-1/2 hidden lg:block">
                    <div className="relative h-full w-full">
                        <Image src="/img/manufacturing/Vial-Inspection.webp" alt="Manufacturing Facility" fill className="object-cover object-left" style={{ maskImage: "linear-gradient(to left, white 70%, transparent 100%)" }} />
                    </div>
                </div>
            </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">A visual journey through our state-of-the-art production facilities</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {manufacturingImages.map((image, index) => (
                            <div key={index} className="group relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
            ...
            <section className="py-20 bg-gradient-to-br from-[#173C96]/10 to-[#031B4E]/10">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">Comprehensive pharmaceutical manufacturing solutions</p>
                        <div className="w-24 h-1 bg-gradient-to-r from-[#173C96] to-[#EB006F] mx-auto mt-6"></div>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {capabilities.map((capability, index) => (
                            <div key={index} className="bg-white p-8 rounded-xl border border-gray-100 hover:border-[#173C96]/50 transition-all hover:-translate-y-2 shadow-sm hover:shadow-md">
                                <div className="w-16 h-16 bg-[#173C96]/10 rounded-xl flex items-center justify-center mb-6">{capability.icon}</div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="lg:w-1/2">
                            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-xl">
                                <Image src="/img/quality-practices/quality-practices.webp" alt="Manufacturing Process" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <div className="space-y-6">
                                {["Raw Material Testing", "Precision Formulation", "Automated Production", "In-Process Quality Checks", "Final Product Testing", "Packaging & Labeling", "Stability Studies", "Distribution"].map(
                                    (step, index) => (
