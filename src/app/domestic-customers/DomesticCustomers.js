      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto mt-4 md:mt-6">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100/50 hover:shadow-md transition-all hover:-translate-y-1"
              >
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="lg:w-1/2">
              <div className="inline-block mb-3 md:mb-4 px-3 py-1 md:px-4 md:py-2 bg-[#173C96]/10 text-[#173C96] rounded-full text-sm font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                <Link 
                  href="/contact"
                  className="px-6 py-3 md:px-8 md:py-3.5 bg-primary text-white rounded-lg font-medium hover:shadow-lg transition-all hover:-translate-y-0.5 text-center text-sm md:text-base"
                >
                  Contact Sales Team
                </Link>
              </div>
