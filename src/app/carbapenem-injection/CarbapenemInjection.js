                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-10 md:mb-0">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">
                            Carbapenem <span className="text-blue-300">Injections</span>
                        </h1>
                        <p className="text-xl text-blue-100 mb-8 max-w-lg">
                            Comprehensive range of high-potency carbapenem antibiotics
                        </p>
                        <div className="w-32 h-1.5 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full mb-8"></div>
                        <p className="text-blue-100 max-w-xl">
                            Our complete carbapenem portfolio includes seven specialized formulations for
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {products.map((product, index) => (
                            ...
                            >
                                {/* Image Container with subtle blue overlay on hover */}
                                ...
                                <div className="p-6 border-t border-gray-100">
                                    {/* Product Name with underline animation */}
                                    ...
                                    {/* Presentation with animated icon */}
