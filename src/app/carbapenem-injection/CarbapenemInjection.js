                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {products.map((product, index) => (
                            <div
                                key={index}
                                className="group bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-[var(--primary)]/30"
                            >
                                {/* Image Container */}
                                <div className="relative h-64 bg-gray-50 overflow-hidden">
                                    <div className="absolute inset-0 bg-[var(--primary)]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"></div>
                                    <Image
                                        src={product.image}
                                        alt={product.name}
                                        fill
                                ...
                                <div className="p-6 border-t border-gray-100">
                                    <div className="relative inline-block mb-3">
                                        ...
                                        <div className="absolute bottom-0 left-0 h-1.5 bg-[var(--primary)]/20 w-0 group-hover:w-full transition-all duration-300 z-0"></div>
                                    </div>
                                    <div className="flex items-center text-sm text-[var(--primary)] font-medium">
                                        ...
                                        <span className="transition-all duration-300 group-hover:text-[var(--primary-dark)]">
