       ...
       <div className="font-sans bg-gray-50">
            ...
            <div className="relative bg-gradient-to-r from-[var(--primary)] to-[var(--tertiary)] text-white py-8 md:py-12 lg:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-8 md:mb-0">
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-6 md:mb-8 max-w-lg">
                            Comprehensive range of high-potency carbapenem antibiotics
                        </p>
                        <div className="w-32 h-1.5 bg-gradient-to-r from-[var(--secondary)] to-[var(--primary-light)] rounded-full mb-6 md:mb-8"></div>
                        <p className="text-sm sm:text-base text-blue-100 max-w-xl">
                            Hygine Lifesciences Pvt Ltd complete carbapenem portfolio includes seven specialized formulations for
            ...
            <section className="py-12 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-gray-600 text-center mb-8 md:mb-12 max-w-3xl mx-auto">
                            ...
                            >
                                ...
                                <div className="p-4 md:p-6 border-t border-gray-100">
                                    <div className="relative inline-block mb-2 md:mb-3">
                                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 relative z-10">
                                            {product.name}
                                        </h3>
                                        <motion.div
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                        ...
                        <table className="w-full border-collapse">
                                ...
                                <tr className="bg-gradient-to-r from-[var(--primary)] to-[var(--tertiary)] text-white">
                                    <th className="p-3 md:p-5 text-left font-bold text-base md:text-lg uppercase tracking-wider">
                                        <div className="flex items-center">
                                           <FaSyringe  className="w-4 h-4 md:w-5 md:h-5 mr-1 md:mr-2" /> 
                                            Products
                                        </div>
                                    </th>
                                    <th className="p-3 md:p-5 text-left font-bold text-base md:text-lg uppercase tracking-wider">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {[
                                    ...
                                    >
                                        <td className="p-3 md:p-5 font-semibold text-gray-800 group-hover:text-[var(--primary)] transition-colors duration-300 text-sm md:text-base">
                                            <div className="flex items-center">
                                                <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[var(--primary)] rounded-full mr-2 md:mr-3 group-hover:animate-pulse"></div>
                                                {item.product}
                                            </div>
                                        </td>
                                        <td className="p-3 md:p-5 text-gray-700 group-hover:text-[var(--tertiary)] transition-colors duration-300 text-sm md:text-base">
                                            <div className="flex flex-wrap gap-1 md:gap-2">
                                                {item.strengths.split(', ').map((strength, i) => (
                                                    <span
                                                        key={i}
                                                        className="px-2 py-0.5 md:px-3 md:py-1 bg-[var(--primary)]/10 text-[var(--primary)] rounded-full text-xs font-medium group-hover:bg-[var(--primary)]/20 transition-all duration-300"
                                                    >
                                                        {strength}
                                                    </span>
                                                ))}
                    ...
                    <div className="mt-6 md:mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <div className="bg-[var(--primary)]/5 p-3 md:p-4 rounded-lg border border-[var(--primary)]/10">
                            <h3 className="font-bold text-[var(--primary)] mb-1 md:mb-2 text-sm md:text-base">Broad Spectrum</h3>
