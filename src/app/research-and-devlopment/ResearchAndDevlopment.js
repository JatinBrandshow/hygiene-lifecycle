...
const ResearchDevelopment = () => {
    ...
    const services = [
        {
            icon: <FaMicroscope className="text-[#173C96] text-3xl" />,
            ...
            <div className="relative h-[500px] bg-gradient-to-br from-[#031B4E] to-[#173C96] text-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
                    <div className="max-w-2xl">
                        ...
                        <div className="w-32 h-1.5 bg-gradient-to-r from-[#EB006F] to-white rounded-full"></div>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="lg:w-1/2 space-y-8">
                            ...
                            <p className="text-xl text-gray-600">
                                Bringing new therapies to market is challenging and complex. At Hygiene Lifesciences Pvt Ltd we remain committed to accelerating drug discovery by powering innovation in pharmaceutical solutions. Our expertise in evaluating market trends, managing laboratory related challenges and developing state-of-the-art research products benefit our customers, who leverage our solutions across diverse therapeutic areas.
                            </p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            <div
                                key={index}
                                className="bg-white p-8 rounded-xl border border-gray-100 hover:shadow-lg transition-all hover:border-[#173C96]/50"
                            >
                                <div className={`w-16 h-16 mb-6 rounded-xl flex items-center justify-center ${index % 3 === 0 ? 'bg-[#173C96]/10' : index % 3 === 1 ? 'bg-[#EB006F]/10' : 'bg-[#031B4E]/10'}`}>
                                    {service.icon}
                                </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="relative">
                        <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-[#173C96]/20 hidden md:block"></div>
                        {[
                            {
                                title: "Market Analysis",
                                description: "Identifying unmet medical needs and market opportunities",
                                icon: <FaChartLine className="text-[#173C96] text-2xl" />
                            },
                            {
                                title: "Target Identification",
                                description: "Selecting biological targets for therapeutic intervention",
                                icon: <FaMicroscope className="text-[#EB006F] text-2xl" />
                            },
                            {
                                title: "Lead Discovery",
                                description: "Finding and optimizing potential drug candidates",
                                icon: <FaLightbulb className="text-[#031B4E] text-2xl" />
                            },
                            {
                            ...
                            },
                            {
                                ...
                                icon: <FaShieldAlt className="text-[#031B4E] text-2xl" />
                            }
                        ].map((step, index) => (
